Pro mst1_graphs,pngplot=pngplot,tr=tr,tdiv=tdiv
...
if tdiv eq 8 then begin
	shots     = [ 35157   , 35167  , 35358 , 35381 , 33257]
	arsteps   = [[3,4,5] , [3,4,5], [-10,3.5,5.0],[2.5,3.5,4.5],[2.6,3.6,4.6]]
endif
