Function get_ratios,shot,los=los
	...
	id     = where(tdiv gt 0 and tdiv le 20 and nii3995 gt 1e18)
	
return,{ratio1:ratio1[id],ratio2:ratio2[id]}
End

Pro ratios_db_30505,los=los,showdens=showdens,psplot=psplot
!quiet=1
num    = 100
...
shot_db = [30505]
if ~keyword_set(los)then los = ['ROV014','ROV012','ROV010','ROV008','ROV006']
